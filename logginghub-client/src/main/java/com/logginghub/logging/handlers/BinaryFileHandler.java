 ...
 * 
 */
public class BinaryFileHandler extends Handler implements PropertyChangeListener {
    ...
    protected synchronized void write(LogEventMessage logEventMessage) throws IOException {
        ...
        ensureChannelOpen();
        m_channel.write(m_buffer.getBuffer());
    ...
    private void ensureChannelOpen() throws IOException {
        if (m_channel == null) {
            ...
            m_channel = new FileOutputStream(file).getChannel();
        }
    }
