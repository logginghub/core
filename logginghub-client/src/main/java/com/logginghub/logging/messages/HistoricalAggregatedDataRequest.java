...
public class HistoricalAggregatedDataRequest extends BaseRequestResponseMessage implements SerialisableObject {
    ...
    public HistoricalAggregatedDataRequest() {}

    public HistoricalAggregatedDataRequest(long start, long end) {
        super();
        this.start = start;
        this.end = end;
    }
