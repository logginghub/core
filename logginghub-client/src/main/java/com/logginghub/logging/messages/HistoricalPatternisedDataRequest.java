...
public class HistoricalPatternisedDataRequest extends BaseRequestResponseMessage implements SerialisableObject {
    ...
    public HistoricalPatternisedDataRequest() {}

    public HistoricalPatternisedDataRequest(long start, long end) {
        super();
        this.start = start;
        this.end = end;
    }
