...
loggingHubModule.controller('LineCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
...
loggingHubModule.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('stats', {
            url: "/stats", templateUrl: "stats.html"
        })

        .state('yearstats', {
            url: "/yearstats/:year", templateUrl: "yearstats.html"
        })

        .state('monthstats', {
            url: "/monthstats?year&month", templateUrl: "monthstats.html"
        })

        .state('daystats', {
            url: "/daystats?year&month&day", templateUrl: "daystats.html"
        })

        .state('hourstats', {
            url: "/hourstats?year&month&day&hour", templateUrl: "hourstats.html"
        })

        .state('minutestats', {
            url: "/minutestats?year&month&day&hour&minute", templateUrl: "minutestats.html"
        })

        .state('secondstats', {
            url: "/secondstats?year&month&day&hour&minute&second", templateUrl: "secondstats.html"
        })
});
...
loggingHubModule.controller('yearstatsController', function ($scope, $stateParams, $http, $q, $interval, $state) {
    ...
    $scope.labels = ["January", "February", "March", "April", "May", "June", "July"];
    $scope.series = ['Series A', 'Series B'];
    $scope.chartData = [[65, 59, 80, 81, 56, 55, 40], [28, 48, 40, 19, 86, 27, 90]];
    $scope.onClick = function (points, evt) {
        if (points.length > 0) {
    ...
    $scope.options = {
        scaleBeginAtZero: true, animationSteps: 10
    }
    ...
    $scope.requestData = function () {
        ...
        var promise = $http({
            method: "GET", url: "/yearstats", params: {"year": $stateParams.year}
        });
...
loggingHubModule.controller('monthstatsController', function ($scope, $stateParams, $http, $q, $interval, $state) {
    ...
    $scope.perfData = [[65, 59, 80, 81, 56, 55, 40], [28, 48, 40, 19, 86, 27, 90]];
    ...
    $scope.requestData = function () {
        ...
        var promise = $http({
            method: "GET", url: "/monthstats", params: {"year": $stateParams.year, "month": $stateParams.month}
        });
...
loggingHubModule.controller('daystatsController', function ($scope, $stateParams, $http, $q, $interval, $state) {
    ...
    $scope.requestData = function () {
        ...
        var promise = $http({
            method: "GET", url: "/daystats", params: {"year": $stateParams.year, "month": $stateParams.month, "day": $stateParams.day}
        });
    ...
    $scope.requestData = function () {
        ...
        var promise = $http({
            ...
            params: {
                ...
                "day": $stateParams.day,
                "hour": $stateParams.hour,
                "minute": $stateParams.minute
            }
        });
