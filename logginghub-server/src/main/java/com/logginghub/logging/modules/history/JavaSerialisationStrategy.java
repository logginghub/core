...
public class JavaSerialisationStrategy implements SerialisationStrategy {
    ...
    @Override public void serialise(ByteBuffer buffer, SerialisableObject logEvent) throws IOException {
    ...
    @Override public SerialisableObject deserialise(ByteBuffer byteBuffer) throws IOException {
