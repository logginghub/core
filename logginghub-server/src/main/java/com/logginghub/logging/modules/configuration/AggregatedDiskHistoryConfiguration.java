...
import com.logginghub.logging.modules.AggregatedDiskHistoryModule;
import com.logginghub.utils.module.Configures;

@Configures(AggregatedDiskHistoryModule.class) @XmlAccessorType(XmlAccessType.FIELD) public class AggregatedDiskHistoryConfiguration {
    ...
    @XmlAttribute private String filename = "aggregated.";
