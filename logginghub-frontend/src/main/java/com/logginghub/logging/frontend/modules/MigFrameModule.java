...
public class MigFrameModule implements LayoutService, FrameService {

    private static final Logger logger = Logger.getLoggerFor(MigFrameModule.class);
    private SmartJFrame frame;
    private String name;
    private boolean quitOnClose = false;
    private String iconResource = "/icons/LoggingHubLogo.png";

    public MigFrameModule(String name) {
