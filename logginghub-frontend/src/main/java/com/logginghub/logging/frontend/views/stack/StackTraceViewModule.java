...
public class StackTraceViewModule implements Module<StackTraceViewConfiguration> {
    ...
    private StackTraceView stackTraceView = new StackTraceView();
    ...
    public void initialise() {
        sendInitialRequests();
        stackTraceView.setName("Stack analysis");
        layoutService.add(stackTraceView, layout);
...
//        sendInitialRequests();
    ...
    @Override public void start() {
        ...
        controller = new StackTraceController(messagingService);

        final StackInstanceFiltersModel stackInstanceFiltersModel = new StackInstanceFiltersModel();
        stackInstanceFiltersModel.getFilters().add(new StackInstanceFilterModel());
        stackTraceView.bind(controller, controller.getThreadViewModelsList(), stackInstanceFiltersModel);

        controller.subsribeToUpdates();
