...
public class InstanceInfoContainsFilter implements Filter<InstanceInfo> {
    ...
    public InstanceInfoContainsFilter() {
    ...
    @Override public boolean passes(InstanceInfo t) {

        boolean passes = portFilter.passes(Integer.toString(t.getLocalPort())) &&
                         nameFilter.passes(t.getName()) &&
                         pidFilter.passes(Integer.toString(t.getPid())) &&
                         hostFilter.passes(t.getHost()) &&
                         ipFilter.passes(t.getIp());
