...
public class ModelBuilder {
    ...
    private EnvironmentModel buildModel(EnvironmentConfiguration environmentConfiguration) {
        ...
        environmentModel.set(EnvironmentModel.Fields.RepoConnectionPoints,
                             environmentConfiguration.getRepoConnectionPoints());
        ...
        for (String string : quickFilters) {
            environmentModel.getQuickFilterHistoryModel()
                            .getEntries()
                            .add(new QuickFilterHistoryEntryModel(string, false));
        }
