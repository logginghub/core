...
public class ReflectionUtils {
    ...
    public static <T> T instantiate(Class<T> clazz) {
        ...
        try {
            ...
            throw FormattedRuntimeException.build(
                    "Failed to instantiate instance of class {} due to access exception, is the class public and default constructor public?",
                    clazz.getName(),
                    e);
        }
        return newInstance;
    ...
    public static <T> List<T> extractAllFields(Object target, Class<?> clazz, Class<? extends T> fieldTypeClass) {
    ...
    public static Field findField(String string,
                                  Object instance) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    @SuppressWarnings("unchecked")
    public static <T> T getFieldRuntime(String string, Object instance) {
        try {
            return (T) getField(string, instance);
        } catch (Exception e) {
            throw new RuntimeException(String.format("Failed to get field %s from object %s of class %s",
                                                     string,
                                                     instance,
    ...
    public static Object getField(String string,
                                  Object instance) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        Class<? extends Object> clazz = instance.getClass();
        Field[] declaredFields = clazz.getDeclaredFields();
        for (Field field : declaredFields) {
            ...
            if (!status.success) {
                ...
                if (!status.success) {
                    throw new RuntimeException(String.format(
                            "We failed to get the value for field '%s' from object '%s' (type '%s'), we tried to access it via the field directly and then via any suitable accessors.",
                            field.getName(),
                            object,
    ...
    public static Object invoke(Object instance, String methodName, Class<?>[] parameterTypes, Object[] parameters) {
        try {
            ...
            throw new RuntimeException(String.format("Method invocation failed for method name %s on class %s",
                                                     methodName,
                                                     instance.getClass().getName()), e);
        }
    ...
    public static void invokeIfMethodExists(String methodToCall, Object toCallOn, Object... arguments) {
        ...
        if (findFirstMethod != null) {
            try {
                ...
                throw new RuntimeException(String.format("Failed to invoke method '%s' on instance of class '%s'",
                                                         methodToCall,
                                                         toCallOn.getClass().getName()), e);
            }
        }
    }
    ...
    public static void setFieldFromString(String fieldName,
                                          Object instance,
                                          String value) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException {
        boolean found = false;
    ...
    /**
     * Class to encapsulate an attempt - we can't just return null if we didn't get the item as this is a valid result.
     *
     * @author James
     */
