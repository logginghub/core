...
public class Helper {
    ...
    static {
        ...
        mimeTypes.put("elc", "application/x-bytecode.elisp");
        ...
        mimeTypes.put("scm", "text/x-script.guile");
        mimeTypes.put("scm", "text/x-script.scheme");
    ...
    public static void redirect(HttpServletResponse response, String path) throws IOException {
        ...
        String x = "<html><body>Redirected: <a href=\"/" + path + "\">" + path + "</a></body></html>";
        response.getWriter().print(x);
    }

    public static void ok(HttpServletResponse response, String content) throws IOException {
        response.setContentType("text/html");
    ...
    public static void unauthorised(HttpServletResponse response) throws IOException {
        response.setContentType("text/html");
        response.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
        response.getWriter().print("");
    }

    public static void ok(HttpServletResponse response, String content, String mime) throws IOException {
        response.setContentType(mime);
        response.setStatus(HttpServletResponse.SC_OK);
        response.getWriter().print(content);
    }

    public static void pageNotFound(HttpServletResponse response) throws IOException {
