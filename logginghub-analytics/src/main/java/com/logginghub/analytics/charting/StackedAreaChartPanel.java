 ...
 * 
 */
public class StackedAreaChartPanel extends JPanel implements ChartPanelInterface {
    ...
    public StackedAreaChartPanel() {

        chart = ChartFactory.createStackedAreaChart("Title", "X", "Y", dataset, PlotOrientation.VERTICAL, true, true, false);
